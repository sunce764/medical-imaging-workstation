...
# =========================================================================
# 主窗口：医学影像工作站
# 负责：DICOM 加载、多平面临床阅片渲染、窗位/工具/布局/Cine/MPR/AI 调度、i18n 重译。
#       UI 构建见 UiBuilderMixin（ui_builder.py），重建实验室见 ReconLabMixin
#       （recon_lab.py），双序列对比见 CompareMixin（compare_lab.py），
#       标注/分割/器官定量见 AnnotationMixin（annotation_lab.py）。
# =========================================================================
class MedicalViewer(QMainWindow, ReconLabMixin, CompareMixin, AnnotationMixin, UiBuilderMixin):
