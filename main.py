...
# =========================================================================
# 主窗口：医学影像工作站 + 重建实验室
# 负责：UI 构建、DICOM 加载、多平面重建显示、标注管理、临床阅片调度。
#       重建实验室调度见 ReconLabMixin（recon_lab.py），双序列对比见 CompareMixin（compare_lab.py）。
# =========================================================================
class MedicalViewer(QMainWindow, ReconLabMixin, CompareMixin):
