...
**Software scale**: application code of about 6,000 lines across 18 modules, accompanied by 516 automated regression checks (424 of which are data-independent and run in CI).
