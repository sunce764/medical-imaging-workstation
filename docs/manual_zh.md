...
> **版本对应关系**：随软件著作权登记提交的说明书 **PDF 为 V1.0 快照**，V1.0 的内容以该 PDF 为准，本文档不对其作任何追溯修改。本 Markdown 源在 V1.0 之后继续维护，已记录若干 V1.0 尚未包含的功能（推理前的 spacing 重采样、逐体素置信度、模型说明卡、重建实验室内置模体等），故与该 PDF 存在差异。这是源码正常演进的结果，不构成对已提交快照的更正。**其中有一处差异属于措辞更正而非功能变化**：已提交 PDF 的封面仍把截图数据写作「非患者数据」，本 Markdown 已改为「公开、已去标识的人体 CT」。登记在审期间，该 PDF 有意保持不动。
