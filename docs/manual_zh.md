...
**开发语言**：Python。
**软件规模**：应用代码约 4,100 行，划分为 13 个模块；配套 325 项自动化回归测试。
...
方法与量化结果见[实验说明](../experiments/README.md)与[技术报告](technical_report.md)研究三：在随机模体家族上，RMSE 较最优线性滤波低 3–6 倍，病灶对比度保留率从与剂量无关的 0.87 天花板提升到 0.96–1.00，且实测虚假结构（幻觉）检出率 1.7%（30% 阈值以上为 0%）。
