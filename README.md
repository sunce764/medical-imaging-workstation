...
```bash
python tests/test_gui.py                     # full suite: 621 locally; requires local RIDER data
SKIP_REAL_DATA=1 python tests/test_gui.py    # 531 locally; 512 on a clean CI runner (see above)
ruff check .                                 # lint
