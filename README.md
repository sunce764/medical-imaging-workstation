...
```bash
python tests/test_gui.py                     # 2026-08-26 local run: 854 full-suite checks; local RIDER present
SKIP_REAL_DATA=1 python tests/test_gui.py    # 2026-08-26 local run: 762 data-independent checks
ruff check .                                 # lint
