...
```bash
python tests/test_gui.py                     # 2026-08-28 local run: 1008 full-suite checks; local RIDER present
SKIP_REAL_DATA=1 python tests/test_gui.py    # 2026-08-28 local run: 897 data-independent checks
ruff check .                                 # lint
