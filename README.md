...
- **The single-case Dice was optimistic — now measured and corrected.** Study II's mean Dice ≈ 0.92 over 21 organs comes from **one series (*n = 1*)**. Study IV re-measured the five lung lobes on **57 ground-truth-labelled public CTs**: **0.8867, 95% CI [0.859, 0.914]**, against 0.956–0.991 for those same lobes on the single case. The largest gap is the **right upper lobe: 0.967 on one case → 0.727 across 57** (CI [0.590, 0.845], present in only 31) — the single case happened to be an easy one. The 21-organ figure itself is still *n = 1*; it has not been re-measured organ by organ.
