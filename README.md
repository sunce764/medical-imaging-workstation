...
```bash
python tests/test_gui.py                     # full suite: 609 locally; requires local RIDER data
SKIP_REAL_DATA=1 python tests/test_gui.py    # 519 locally; 500 on a clean CI runner (see above)
ruff check .                                 # lint
