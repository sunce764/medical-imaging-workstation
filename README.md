...
```bash
python tests/test_gui.py                     # 2026-08-27 local run: 867 full-suite checks; local RIDER present
SKIP_REAL_DATA=1 python tests/test_gui.py    # 2026-08-27 local run: 775 data-independent checks
ruff check .                                 # lint
